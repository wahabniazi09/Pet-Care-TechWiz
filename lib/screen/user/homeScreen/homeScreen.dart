...
import 'package:pet_care/screen/user/homeScreen/view_all_screen.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.location_on, size: isSmallScreen ? 12 : 14, color: Colors.deepOrange),
          ...
          Center(
            child: ElevatedButton.icon(
              ...
              label: Text("Adopt Now", style: TextStyle(fontSize: isSmallScreen ? 12 : 14)),
              style: _buttonStyle(),
            ),
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _imageBuilder(blog["image"], isSmallScreen ? 120 : 140, Icons.article),
            Padding(
              padding: EdgeInsets.all(isSmallScreen ? 8.0 : 12.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Row(
                    children: [
                      Icon(Icons.calendar_today,
                          size: isSmallScreen ? 10 : 12, color: Colors.grey[600]),
                      const SizedBox(width: 4),
                      ...
                      const SizedBox(width: 8),
                      Icon(Icons.person, size: isSmallScreen ? 10 : 12, color: Colors.grey[600]),
                      const SizedBox(width: 4),
  ...
  Widget _productCard(Map<String, dynamic> product) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _imageBuilder(product["p_image"], isSmallScreen ? 140 : 160, Icons.shopping_bag),
          Padding(
            padding: EdgeInsets.all(isSmallScreen ? 8.0 : 12.0),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _vetCard(Map<String, dynamic> vet) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _imageBuilder(vet["profilePic"], isSmallScreen ? 120 : 140, Icons.person),
          Padding(
            padding: EdgeInsets.all(isSmallScreen ? 8.0 : 12.0),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(child: SizedBox(height: isSmallScreen ? 16 : 24)),
