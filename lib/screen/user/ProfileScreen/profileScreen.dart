...
import 'package:pet_care/screen/user/ProfileScreen/adoptionScreen.dart';
import 'package:pet_care/screen/user/ProfileScreen/cartScreen.dart';
import 'package:pet_care/screen/user/ProfileScreen/editProfile.dart';
...
class AppointmentsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      Scaffold(appBar: AppBar(title: const Text("Appointments")));
}
